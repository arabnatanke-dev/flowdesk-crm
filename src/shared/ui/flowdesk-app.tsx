...
import type { WorkOrder } from "@/src/modules/work-orders/domain/work-order";
...
export function FlowDeskApp({ orgSlug, organizationName, displayName, role, initialSettings, section, initialWorkOrders }: FlowDeskAppProps) {
  ...
  return (
    <WorkOrderProvider orgSlug={orgSlug} initialWorkOrders={initialWorkOrders}>
